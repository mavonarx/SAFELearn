    ...
    def train(self):
        ...
        for client_index, c in enumerate(selected_clients):
            ...
            if (client_index == 0):
                ...
                print(weights_before[4].shape, "shape of selected array") 
                print(weights_before[4], "entry of chosen array") 
                print(weights_before[5].shape, "shape of selected array") 
                print(weights_before[5], "entry of chosen array") 
