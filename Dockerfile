...
RUN git clone https://github.com/mavonarx/ABY.git && git clone https://github.com/mavonarx/SAFELearn.git
...
RUN python3 -m pip install scikit-learn pandas torcheval tensorflow
